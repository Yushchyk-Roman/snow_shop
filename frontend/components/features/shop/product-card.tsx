    ...
    >
      <div className="h-110 w-full relative overflow-hidden rounded-t-2xl ">
        ...
        <div className="flex absolute gap-2 top-4 left-4 text-sm">
          <p className="uppercase px-4 py-1 rounded-xl bg-future-grad text-white">
            trending
          </p>
          <p className="uppercase px-4 py-1 rounded-2xl  bg-add-color text-white">
            New
          </p>
        </div>
...
<ShoppingCart />
      ...
      <div className="px-6 py-4 flex flex-col gap-2 ">
        <p className="text-add-color font-medium  uppercase">Apex</p>
        <h4 className="text-2xl font-medium">Artic Phantom Elite</h4>
        <div className="flex gap-2 text-white/50 mb-2">
          <p className="bg-filter-bg px-2 py-1 border border-white/20 rounded-lg ">
            All-Mountain
          </p>
          <p className="bg-filter-bg p-1 border border-white/20 rounded-lg ">
            Traditional Camber
          </p>
        </div>
